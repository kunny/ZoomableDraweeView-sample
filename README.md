# Fresco ZoomableDraweeView sample [![Build Status](https://travis-ci.org/kunny/ZoomableDraweeView-sample.svg?branch=master)](https://travis-ci.org/kunny/ZoomableDraweeView-sample)
